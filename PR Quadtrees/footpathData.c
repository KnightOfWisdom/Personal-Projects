/* footpathData.c
*
* Created by Ke Liao (keliao@student.unimelb.edu.au) 14/08/2022
*
...
* file printing of struct. This module was from assignment 1
*
* However, additional functionalities were added to facilitate the construction
* of quad tree. The functions were added on 06/09/2022
* 
*/
